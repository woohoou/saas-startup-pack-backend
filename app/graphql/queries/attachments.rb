module Queries
  module Attachments
    ...
    def self.included(c)
      ...
      c.field :attachment, Types::Attachment, null: true, description: "File relation for active storage models" do
        argument :input, AttachmentsAttributes, required: true
      end
      c.field :attachments, [Types::Attachment], null: false, description: "Attachments relation for active storage models" do
        argument :input, AttachmentsAttributes, required: true
      end
    end
